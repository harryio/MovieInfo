package io.thappx.movieinfo.util;
...
public class DrawableUtils {
    ...
    public static Drawable getListItemBackground(int baseColor, int numStops, int gravity) {
        if (sBackgroundDrawable == null) {
            sBackgroundDrawable = makeCubicGradientScrimDrawable(baseColor, numStops, gravity);
        }

        return sBackgroundDrawable;
    }
}
